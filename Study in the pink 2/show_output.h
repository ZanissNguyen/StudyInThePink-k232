...
public:
    ...
    static void tc_m001()
    {
        ...
        Sherlock * sherlock = new Sherlock(1, "RUU", Position(0,0), map, 91, 401);
        Watson * watson = new Watson(2, "LU", Position(2, 1), map, 320, 350);
        Criminal * criminal = new Criminal(0, Position(7, 9), map, sherlock, watson);
        ...
        RobotS * robot = new RobotS(3, Position(3,5), map, criminal, sherlock);

        SherlockEvents(sherlock, sBag, watson, wBag, criminal, robot, false);
    ...
    static void tc_m002()
    {
        cout << "----- My Testcase 002 -----" << endl;
        StudyPinkProgram * program = new StudyPinkProgram("181.txt");
    ...
    static void tc_m004()
    {
        cout << "----- My Testcase 004 -----" << endl;
        StudyPinkProgram * program = new StudyPinkProgram("185.txt");
    ...
    static void tc_m006()
    {
        ...
        Position testPos(1,4);

        Sherlock * sherlock = new Sherlock(1, "RUU", testPos, map, 91, 341);
        Watson * watson = new Watson(2, "LU", Position(2, 1), map, 320, 350);
        Criminal * criminal = new Criminal(0, Position(7, 9), map, sherlock, watson);

        SherlockBag * sBag = new SherlockBag(sherlock);
        sBag->insert(new FirstAid());
        sBag->insert(new ExcemptionCard());
        sBag->insert(new ExcemptionCard());
        cout << sBag->str() << endl;

        WatsonBag * wBag = new WatsonBag(watson);
    
        RobotS * robot = new RobotS(3, testPos, map, criminal, sherlock);
    ...
    static void tc_m007()
    {
        ...
        Sherlock * sherlock = new Sherlock(1, "RUU", Position(0,0), map, 91, 341);
...
void test() {
    ...
    cout << endl;
    TestStudyInPink::tc_m001();
    cout << endl;
    TestStudyInPink::tc_m002();
    cout << endl;
    TestStudyInPink::tc_m003();
    cout << endl;
    TestStudyInPink::tc_m004();
    cout << endl;
    TestStudyInPink::tc_m005();
    cout << endl;
    TestStudyInPink::tc_m006();
    cout << endl;
    TestStudyInPink::tc_m007();
    cout << endl;
}